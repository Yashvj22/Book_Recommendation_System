...
# hybride = pickle.load(open('hybrid_model.pkl', 'rb'))
...
#     for i in similar_items:
#         temp_df = books[books['Book-Title'] == pt.index[i[0]]]
#         recommendations.append((temp_df['Book-Title'].values[0], temp_df['Book-Author'].values[0]))
...
#         print(user_input)
#         arr=['Animal farm','1987','Classical Mythology','Decision in Normandy','PLEADING GUILTY','Nights Below Station Street','Jane Doe','The Testament','Wild Animus','Airfame','Wild Animus2','Timeline','Lying Awake']
#         for i in arr:
#             if(user_input==i):
#                 print(user_input)
...
#         search_results = None
#         # if user_input in recommend1['Book-Title'].values():
#         #     search_results = "found"
#         return render_template('search.html', data=user_input)
